...
Particle range lookup helper.

It supports muons, charged pions, charged kaons, and protons using the common
E_vs_dist/overall_distances table format.
...
def default_range_table_paths(particle: str, table_dirs=None):
    ...
    # Backward-compatible fallback for the historical muon filenames.
    if pname == "muon":
